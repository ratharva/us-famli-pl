...
class EfficientNet(pl.LightningModule):
    def __init__(self, args = None, base_encoder='efficientnet_b0', num_classes=4, lr=1e-3, weight_decay=1e-4, class_weights=None, num_channels=3):
        super().__init__()
        ...
        self.convnet.features[0][0] = nn.Conv2d(self.num_channels, 32, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
        # print(self.convnet.features[0][0])
