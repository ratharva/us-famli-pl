...
def main(args):
    ...
    #CALCULATE ROC STATS
        ...
        plt.savefig("/mnt/raid/home/ayrisbud/us-famli-pl/src/classification_report/epoch=74-val_loss=0.09_auc.png")
        ...
        dfCombined.to_csv("/mnt/raid/home/ayrisbud/us-famli-pl/src/predictedClassifierFullPred.csv", index=False)
        ...
        myClassDf.to_csv("/mnt/raid/home/ayrisbud/us-famli-pl/src/classification_report/epoch=74-val_loss=0.09.csv", header=True, index=True)
        print(myClassDf)
        ...
        plt.tight_layout()
        plt.show()
        plt.savefig("/mnt/raid/home/ayrisbud/us-famli-pl/src/classification_report/epoch=74-val_loss=0.09_confMat.png")
