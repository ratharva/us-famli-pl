...
def main(args):
    ...
    train_transform = ZGanTrainTransforms()
    valid_transform = ZGanEvalTransforms()

    usdata = USZDataModule(df_train, df_val, df_test, mount_point=args.mount_point, batch_size=args.batch_size, num_workers=args.num_workers, img_column='img_path', drop_last=True, train_transform=train_transform, valid_transform=valid_transform)
